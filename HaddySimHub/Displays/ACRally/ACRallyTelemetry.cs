...
/// <summary>
/// Assetto Corsa Rally telemetry data from shared memory
/// Based on AC shared memory structure adapted for rally
/// </summary>
...
public struct ACRallyTelemetry
{
    ...
    // Tyre data (P1-P4: Front-Left, Front-Right, Rear-Left, Rear-Right)
    ...
    public float NormalizedSplinePosTrack;  // track position (0-1)
    ...
    // Rally stage specific
    public int SessionIndex;           // session/stage index
    public int SessionType;            // 0 = practice, 1 = qualify, 2 = race/rally stage
    public int CurrentLapInvalid;      // current lap/stage invalid
    public int CurrentLap;             // current lap/stage
    public int TotalLaps;              // total laps/stages
    public int LastLapTime;            // last lap/stage time in ms
    public int CurrentLapTime;         // current lap/stage time in ms
    public int DeltaLapTime;           // delta to best lap/stage in ms
    public int ICurrentTime;           // current track/stage time in ms
