...
public class IRacingDataConverter : IDataConverter<IDataSample, DisplayUpdate>
{
    ...
    public IRacingDataConverter()
    {
    }

    public DisplayUpdate Convert(IDataSample data)
    {
        ...
        string carScreenName = telemetry.ContainsKey("CarScreenName") ? telemetry["CarScreenName"].ToString() ?? string.Empty : string.Empty;
