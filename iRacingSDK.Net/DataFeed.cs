...
public class DataFeed(MemoryMappedViewAccessor accessor)
{
    readonly MemoryMappedViewAccessor accessor = accessor;
    ...
    static readonly int size = Marshal.SizeOf<VarHeader>();
