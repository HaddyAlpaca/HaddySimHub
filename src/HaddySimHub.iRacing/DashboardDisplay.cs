...
public sealed class DashboardDisplay : DisplayBase
{
    public DashboardDisplay(Action<DisplayUpdate> updateFn)
        : base(updateFn)
    {
        iRacingSDK.iRacing.NewData += (dataSample) =>
        {
    ...
    protected override DisplayType Type => DisplayType.RaceDashboard;
