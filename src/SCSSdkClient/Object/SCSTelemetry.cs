...
namespace SCSSdkClient.Object
{
    ...
    public partial class SCSTelemetry {
        ...
        /// </summary>
        public Common CommonValues { get; internal set; } = new();

        /// <summary>
        ///     Contains values about the user and game control
        /// </summary>
        public Control ControlValues { get; internal set; } = new();
        ...
        public SCSGame Game { get; internal set; } = new();

        public GamePlayEvents GamePlay { get; internal set; } = new();
        ...
        /// Does NOT match the patch level of the game.
        /// <!----> **INFORMATION** <!---->
        public Version GameVersion { get; internal set; } = new();

        /// <summary>
        ///     Contains values of the actual job
        /// </summary>
        public Job JobValues { get; internal set; } = new();
        ...
        ///     Navigation values
        /// </summary>
        public Navigation NavigationValues { get; internal set; } = new();
        ...
        /// </summary>
        public SpecialEvents SpecialEventsValues { get; internal set; } = new();
        ...
        /// </summary>
        public Version TelemetryVersion { get; internal set; } = new();
        ...
        /// </summary>
        public Truck TruckValues { get; internal set; } = new();
    }
}
