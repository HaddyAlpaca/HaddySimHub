...
namespace SCSSdkClient.Object {
    ...
    public partial class SCSTelemetry {
        ...
        public class Trailer {
            ...
            public string BodyType { get; internal set; } = string.Empty;

            public string Brand { get; internal set; } = string.Empty;

            public string BrandId { get; internal set; } = string.Empty;

            /// <summary>
            ///     Name of cargo accessory for internal use by code.
            ///     Limited to C-identifier characters and dots.
            /// </summary>
            public string CargoAccessoryId { get; internal set; } = string.Empty;

            public string ChainType { get; internal set; } = string.Empty;
            ...
            /// </summary>
            public FVector Hook { get; internal set; } = new();
            ...
            public string LicensePlateCountry { get; internal set; } = string.Empty;

            public string LicensePlateCountryId { get; internal set; } = string.Empty;
