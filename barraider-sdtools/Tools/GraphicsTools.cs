...
namespace BarRaider.SdTools
{
    ...
    public static class GraphicsTools
    {
        ...
        {
            Rectangle rec = new(startX, startY, width, height);
            using Bitmap src = new(image);
        ...
        public static string WrapStringToFitImage(string str, TitleParameters titleParameters, int leftPaddingPixels = 5, int rightPaddingPixels = 5, int imageWidthPixels = 72)
        {
            try
            {
                ...
                Font font = new(titleParameters.FontFamily, (float)titleParameters.FontSizeInPixels, titleParameters.FontStyle, GraphicsUnit.Pixel);
