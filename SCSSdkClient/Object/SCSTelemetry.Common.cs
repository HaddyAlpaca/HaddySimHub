...
namespace SCSSdkClient.Object {
    ...
    public partial class SCSTelemetry {
        ...
        public class Common {
            ...
            /// </code>
            /// </example>
            public Time GameTime { get; protected internal set; } = new();

            /// <summary>
            ///     Time until next rest stop.
            /// </summary>
            public Frequency NextRestStop { get; internal set; } = new();
            ...
            /// </code>
            /// </example>
            public Time NextRestStopTime => new() { Value = (uint)((int)GameTime.Value + NextRestStop.Value) };
