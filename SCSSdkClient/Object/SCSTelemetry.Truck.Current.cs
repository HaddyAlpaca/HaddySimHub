    ...
    public partial class SCSTelemetry {
        public partial class Truck {
            ...
            public class Current {
                ...
                /// </summary>
                public Motor MotorValues { get; internal set; } = new();

                /// <summary>
                ///     Values that are displayed at the dashboard like rpm, fuelValue, ...
                ///     <seealso cref="Dashboard" /> for more information
                /// </summary>
                public Dashboard DashboardValues { get; internal set; } = new();

                /// <summary>
                ///     Information about the Lights of the truck
                ///     <seealso cref="Lights" /> for more information
                /// </summary>
                public Lights LightsValues { get; internal set; } = new();

                /// <summary>
                ///     Current values of the wheels like rotation, substance, ...
                ///     <seealso cref="Wheels" />
                /// </summary>
                public Wheels WheelsValues { get; internal set; } = new();

                /// <summary>
                ///     Wear of the Truck
                /// </summary>
                public Damage DamageValues { get; internal set; } = new();

                /// <summary>
                ///     Acceleration of the Truck
                ///     <seealso cref="Acceleration" /> for more information
                /// </summary>
                public Acceleration AccelerationValues { get; internal set; } = new();

                /// <summary>
                ///     Represents world space position and orientation of the truck.
                /// </summary>
                public DPlacement PositionValue { get; protected internal set; } = new();
                ...
                public class Motor {
                    ...
                    /// </summary>
                    public Gear GearValues { get; internal set; } = new();

                    /// <summary>
                    ///     Information around the brake state
                    /// </summary>
                    public Brakes BrakeValues { get; internal set; } = new();
                ...
                public class Dashboard {
                    ...
                    /// </summary>
                    public Fuel FuelValue { get; internal set; } = new();

                    /// <summary>
                    ///     Display active warnings
                    /// </summary>
                    public Warnings WarningValues { get; internal set; } = new();
                    ...
                    /// Uses negative value to represent reverse movement
                    /// <!----> **INFORMATION** <!---->
                    public Movement Speed { get; internal set; } = new();
                    ...
                    /// <!----> **INFORMATION** <!---->
                    public Movement CruiseControlSpeed { get; internal set; } = new();
                ...
                public class Lights {
                    ...
                    /// </summary>
                    public AuxLevel AuxFront { get; internal set; } = new();

                    /// <summary>
                    ///     Are the auxiliary roof lights active?
                    /// </summary>
                    public AuxLevel AuxRoof { get; internal set; } = new();
