...
namespace SCSSdkClient.Object {
    public partial class SCSTelemetry {
        ...
        public class PositionData {
            ...
            /// have a separate cabin.
            /// <!----> **INFORMATION** <!---->
            public FVector Cabin { get; internal set; } = new();

            /// <summary>
            ///     Default position of the head in the cabin space
            /// </summary>
            public FVector Head { get; internal set; } = new();
            ...
            /// </summary>
            public FPlacement HeadOffset { get; internal set; } = new();

            /// <summary>
            ///     Represents a vehicle space position and orientation delta
            ///     of the cabin from its default position.
            /// </summary>
            public FPlacement CabinOffset { get; internal set; } = new();


            internal DPlacement TruckPosition { get; set; } = new();
